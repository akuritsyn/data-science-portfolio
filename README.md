...
[Modular code](https://github.com/akuritsyn/udacity-ml-nanodegree/tree/master/pneumothorax) based on PyTorch only developed for Udacity ML Engineer Nanodegree Capstone project and [final report](https://github.com/akuritsyn/udacity-ml-nanodegree/blob/master/pneumothorax/capstone-final-report.pdf). \
